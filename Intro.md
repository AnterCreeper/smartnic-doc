...
<div align="center">
<image src="pic/infiniband.webp" alt="Infiniband Diagram" width="512">
</div>
...
<div align="center">
<image src="pic/ovs.png" alt="Open vSwitch Diagram" width="384">
</div>
 
 - 存储虚拟化: 云计算厂商将存储集中池化, 计算节点通过网络远程访问存储池(如 NVME-oF)，以实现集中管理和分配，具有更高的灵活性和扩展性。需要硬件卸载以减少 CPU 开销。
<div align="center">
<image src="pic/san.jpg" alt="SAN Diagram" width="512">
</div>
...
<div align="center">
<image src="pic/history.png" alt="NIC History" width="512">
</div>

1. Foundational NIC (obsoleted)
...
3. 独立可编程智能网卡 (Discrete Programmable SmartNIC)
...
<div align="center">
<image src="pic/pensando.png" alt="NIC History" width="384">
</div>
<div align="center">
<image src="pic/dpu.png" alt="NIC History" width="512">
</div>
...
## Category of SmartNIC Mechanism
<div align="center">
<image src="pic/on_off_path.png" alt="Compare" width="512">
</div>
...
<div align="center">
<image src="pic/bf3_arch.png" alt="Off-Path SmartNIC" width="512">
</div>
...
#### NVIDIA BlueField-3
<div align="center">
<image src="pic/dpa.webp" alt="Off-Path SmartNIC" width="512">
</div>
